...
async def lifespan(app: FastAPI):
    _scheduler.add_job(adaptation_agent.poll_lta_alerts, "interval", minutes=2, id="lta_poll")
    _scheduler.add_job(adaptation_agent.poll_weather_alerts, "interval", minutes=30, id="weather_poll")
    _scheduler.start()
    yield
